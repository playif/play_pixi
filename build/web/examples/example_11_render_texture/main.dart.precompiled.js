...
function dart_precompiled($collectedClasses) {
  ...
  function DisplayObject(rotation, hitArea, interactiveChildren, __hit, __isOver, mousemove, mousedown, _interactive) {
  ...
  DisplayObject.prototype.set$interactiveChildren = function(v) {
  ...
  function CanvasBuffer(width, height, canvas, context) {
    this.width = width;
    this.height = height;
    this.canvas = canvas;
    this.context = context;
  }
  CanvasBuffer.builtin$cls = "CanvasBuffer";
  if (!"name" in CanvasBuffer)
    CanvasBuffer.name = "CanvasBuffer";
  $desc = $collectedClasses.CanvasBuffer;
  if ($desc instanceof Array)
    $desc = $desc[1];
  CanvasBuffer.prototype = $desc;
  CanvasBuffer.prototype.get$context = function() {
    return this.context;
  };
  function RenderSession(gl, projection, offset, drawCount, shaderManager, maskManager, filterManager, spriteBatch, renderer, currentBlendMode, scaleMode, context, roundPixels) {
    this.gl = gl;
  ...
  RenderSession.prototype.get$gl = function() {
    return this.gl;
  };
  RenderSession.prototype.set$gl = function(v) {
    return this.gl = v;
  };
  RenderSession.prototype.get$projection = function() {
    return this.projection;
  };
  RenderSession.prototype.set$projection = function(v) {
    return this.projection = v;
  };
  RenderSession.prototype.set$offset = function(receiver, v) {
    return this.offset = v;
  };
  RenderSession.prototype.get$drawCount = function() {
    return this.drawCount;
  };
  RenderSession.prototype.set$drawCount = function(v) {
    return this.drawCount = v;
  };
  RenderSession.prototype.get$shaderManager = function() {
    return this.shaderManager;
  };
  RenderSession.prototype.set$shaderManager = function(v) {
    return this.shaderManager = v;
  };
  RenderSession.prototype.set$maskManager = function(v) {
    return this.maskManager = v;
  };
  RenderSession.prototype.set$filterManager = function(v) {
    return this.filterManager = v;
  };
  RenderSession.prototype.get$spriteBatch = function() {
    return this.spriteBatch;
  };
  RenderSession.prototype.set$spriteBatch = function(v) {
    return this.spriteBatch = v;
  };
  RenderSession.prototype.set$renderer = function(v) {
    return this.renderer = v;
  };
  RenderSession.prototype.set$currentBlendMode = function(v) {
    return this.currentBlendMode = v;
  };
  ...
  function PrimitiveShader(gl, program, fragmentSrc, vertexSrc, projectionVector, offsetVector, tintColor, translationMatrix, aVertexPosition, colorAttribute, attributes, alpha, uniforms) {
    this.gl = gl;
    this.program = program;
    this.fragmentSrc = fragmentSrc;
    this.vertexSrc = vertexSrc;
  ...
  FilterTexture.prototype.get$frameBuffer = function() {
  ...
  function WebGLRenderer(PIXI$WebGLRenderer$transparent, PIXI$WebGLRenderer$antialias, type, transparent, antialias, width, height, view, projection, offset, contextLost, options, gl, shaderManager, spriteBatch, maskManager, filterManager, renderSession, __stage) {
  ...
  function RenderTexture(renderer, PIXI$RenderTexture$width, PIXI$RenderTexture$height, PIXI$RenderTexture$frame, PIXI$RenderTexture$scaleMode, PIXI$RenderTexture$baseTexture, textureBuffer, projection, render, noFrame, updateFrame, frame, trim, scope, _uvs, baseTexture, tintCache, needsUpdate, isTiling, canvasBuffer, id, width, height, scaleMode, _hasLoaded, source, _glTextures, imageUrl, _powerOf2, onLoaded, listeners) {
    this.renderer = renderer;
    this.PIXI$RenderTexture$width = PIXI$RenderTexture$width;
    this.PIXI$RenderTexture$height = PIXI$RenderTexture$height;
    this.PIXI$RenderTexture$frame = PIXI$RenderTexture$frame;
    this.PIXI$RenderTexture$scaleMode = PIXI$RenderTexture$scaleMode;
    this.PIXI$RenderTexture$baseTexture = PIXI$RenderTexture$baseTexture;
  ...
  RenderTexture.prototype.set$width = function(receiver, v) {
    return this.PIXI$RenderTexture$width = v;
  };
  RenderTexture.prototype.set$height = function(receiver, v) {
    return this.PIXI$RenderTexture$height = v;
  };
  RenderTexture.prototype.get$frame = function() {
    return this.PIXI$RenderTexture$frame;
  };
  RenderTexture.prototype.set$frame = function(v) {
    return this.PIXI$RenderTexture$frame = v;
  };
  RenderTexture.prototype.get$baseTexture = function() {
    return this.PIXI$RenderTexture$baseTexture;
  };
  RenderTexture.prototype.set$baseTexture = function(v) {
    return this.PIXI$RenderTexture$baseTexture = v;
  };
  function Texture(noFrame, updateFrame, frame, trim, scope, _uvs, baseTexture, tintCache, needsUpdate, isTiling, canvasBuffer, id, width, height, scaleMode, _hasLoaded, source, _glTextures, imageUrl, _powerOf2, onLoaded, listeners) {
    this.noFrame = noFrame;
    this.updateFrame = updateFrame;
    this.frame = frame;
    this.trim = trim;
  ...
  Texture.prototype.set$frame = function(v) {
    return this.frame = v;
  };
  ...
  Texture.prototype.set$baseTexture = function(v) {
    return this.baseTexture = v;
  };
  ...
  function main_animate(box_0, stage_1, renderer_2, outputSprite_3, stuffContainer_4, items_5) {
    this.box_0 = box_0;
    this.stage_1 = stage_1;
    this.renderer_2 = renderer_2;
    this.outputSprite_3 = outputSprite_3;
    this.stuffContainer_4 = stuffContainer_4;
