...
class CanvasRenderer extends Renderer {
  ...
  CanvasRenderer([int width=800, int height=600, CanvasElement view, this.transparent=false, this.antialias=false]) {
...
//          this.renderSession.smoothProperty = "oImageSmoothingEnabled";
  ...
  renderDisplayObject(DisplayObject displayObject, [CanvasRenderingContext2D context]) {
    // no longer recursive!
    //var transform;
